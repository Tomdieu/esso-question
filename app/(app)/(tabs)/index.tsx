        ...
        <View className="min-h-[85vh]">
          ...
          <View className="shadow-md flex-row items-center justify-between px-2 py-5 bg-white">
            <View className="flex-row items-end gap-2">
              <Text className="text-3xl font-inter-semibold text-gray-800">
                Welcome,
              </Text>
          ...
          <View className="mt-6 flex-1">
            <Text className="text-4xl font-inter-bold text-gray-900 px-2 uppercase">
              Ideogramme
            </Text>
          ...
          <View className="mt-10 px-2">
            <TouchableOpacity className="bg-blue-500 rounded-md py-4 flex-row items-center justify-center shadow-lg">
              ...
              <Text className="text-lg font-inter-semibold text-white ml-2">
